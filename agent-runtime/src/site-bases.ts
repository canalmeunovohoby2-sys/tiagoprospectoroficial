...
- O `src/site.json` da base é PLACEHOLDER (vazio/genérico) — NUNCA o use como direção criativa nem como fonte do plano de imagens. Se ele trouxer nome genérico ou de TESTE (ex.: "TESTE…", "Exemplo", "Lorem"), trate como AUSENTE. A direção (negócio, segmento, tom, imagens) vem SEMPRE dos dados do cliente (briefing/lead) e das fotos reais em assets/; o image_plan deve ser chamado com o SEGMENTO REAL do cliente, nunca com o nome do rascunho.
