// LOCKFILE do template React (gerado por `npm install --package-lock-only` a partir do
// PKG deste arquivo). Motivo (FASE 7.1): o WebContainer oficialmente documenta que SEM
// package-lock.json ele precisa resolver a árvore de dependências na rede antes de baixar
// — "Slower boot time". Com o lock, o boot/install do Preview é muito mais rápido.
// NÃO editar à mão: se as dependências do template mudarem, regenere.
export const REACT_TEMPLATE_LOCK = `{
